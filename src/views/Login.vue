    ...
    <div class="admin-login d-flex flex-column align-center">
      ...
      <div class="login-form">
        <v-card class="login-form__card" elevation="5">
          ...
          <v-form class="login-form__fields pa-4 pb-5">
            <v-layout column class="login-field-item">
              <v-label>
            ...
            <v-layout column class="login-field-item">
              <v-label>
                ...
                <v-text-field outlined solo type="password"></v-text-field>
              </v-label>
            </v-layout>
            <v-layout
              ...
              no-gutters
            >
              <v-btn class="login-control-button" color="primary" text
                >Запросить доступ</v-btn
              >
              <v-btn class="login-control-button" color="primary">Войти</v-btn>
            </v-layout>
          </v-form>
        </v-card>
      </div>
